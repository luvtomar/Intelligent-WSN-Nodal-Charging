function [] = second_scenario()

global EV N periods home_vehicles Ct_available_EU Pt_available_EU pc home_vehicle_SOC_predictions_param
...
for t = 1:periods
    ...
    for i = 1:N
        ...
        EV(i).profit = EV(i).profit + EV(i).y(t)*Pt_available_EU(t) - EV(i).x(t)*Ct_available_EU(t) - pc*EV(i).z(t);
    end
end
